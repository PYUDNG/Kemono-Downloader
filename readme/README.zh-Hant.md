...
> 目前專案依然處於積極開發階段，包括但不限於 *bug滿天飛*、*時靈時不靈* 等等都是預期現象，遇到錯誤請 [提出issue](https://github.com/PYUDNG/Kemono-Downloader/issues) 共同討論解決
...
- <del>[Greasyfork](#)</del> Greasyfork版尚未上傳
...
本專案採用 [GPL-3.0](https://spdx.org/licenses/GPL-3.0-or-later.html) 授權許可證。

## 🙏 致謝

- [vite-plugin-monkey](https://github.com/lisonge/vite-plugin-monkey) - 用於建構使用者腳本的 Vite 外掛
