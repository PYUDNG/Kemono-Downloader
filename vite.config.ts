    ...
    plugins: [
        ...
        monkey({
            ...
            userscript: {
                ...
                description: {
                    '': 'A modern UI, multi-download method, customizable Pawchive/Kemono downloader',
                    'en': 'A modern UI, multi-download method, customizable Pawchive/Kemono downloader',
                    'zh': '一個具有現代化UI、多下載途徑、可自定義的Pawchive/Kemono下載器',
                    'zh-CN': '一个具有现代化UI、多下载途径、可自定义的Pawchive/Kemono下载器',
                    'zh-TW': '一個具有現代化UI、多下載途徑、可自定義的Pawchive/Kemono下載器',
                },
                version: pkg.version,
